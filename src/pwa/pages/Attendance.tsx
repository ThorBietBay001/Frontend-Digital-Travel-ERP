      ...
      <div className="grid grid-cols-3 gap-2 items-center">
        ...
        <div className="col-span-2 relative">
          ...
          <input
            ...
            className="w-full text-xs pl-8 pr-2 py-1.5 rounded-xl border border-slate-200 outline-none bg-white focus:border-sky-400 transition select-text"
          />
        </div>
        ...
        <select
          ...
          className="text-xs p-1.5 rounded-xl border border-slate-200 bg-white font-medium text-slate-600 outline-none focus:border-sky-400"
        >
          ...
          <option value="VANG">Vắng mặt ({attendanceStats.absent})</option>
        </select>
      </div>
                ...
                {attendanceFilter === 'ALL' ? (
                  <div className="flex items-center">
                    <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${
                      isUnmarked ? 'bg-slate-100 text-slate-500 border border-slate-200' :
                  ...
                  <div className="flex space-x-1">
                    <button
                      ...
                      className="px-2.5 py-1 text-[11px] font-bold rounded-lg bg-emerald-500 hover:bg-emerald-600 text-white transition active:scale-95 flex items-center"
                    >
                      Có mặt
                    </button>
                    <button
                      onClick={() => handleAttendanceChange(p.code, 'VANG')}
                      className="px-2.5 py-1 text-[11px] font-bold rounded-lg bg-rose-500 hover:bg-rose-600 text-white transition active:scale-95"
                    >
                      Vắng
                    </button>
                  </div>
            ...
            <div className="flex space-x-2">
              ...
              >
               ...
               <button
                ...
                className={`flex-1 py-2 text-white text-xs font-bold rounded-xl shadow-md transition ${
                  absentReasonText === 'Lý do khác' && !customAbsentReason.trim()
